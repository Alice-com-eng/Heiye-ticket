...
public class PassengerController {
    ...
    @Operation(summary = "根据用户名查询乘车人列表")
    ...
    @Operation(summary = "根据乘车人 ID 集合查询乘车人列表")
    public Result<List<PassengerActualRespDTO>> listPassengerQueryByIds(@RequestParam("username") String username, @RequestParam("ids") List<String> ids) {
